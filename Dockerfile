...
# Собрать образ
# sudo docker build -t catsgram-image .

# Посмотреть список образов
# sudo docker image ls

# Удалить образ
# sudo docker image rm <ID образа>

# Запустить контейнер
# sudo docker run --name catsgram -p 8080:8080 catsgram-image
# или
# sudo docker container create catsgram
# sudo docker container start catsgram
...
# sudo docker rm -f catsgram
# или
# sudo docker container stop catsgram
# sudo docker rm catsgram
